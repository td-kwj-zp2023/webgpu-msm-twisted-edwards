...
export const precompile_shaders = async (
    ...
    const new_point_x_y_sb = create_sb(device, 0)
    const new_point_t_z_sb = create_sb(device, 0)
    const point_x_y_sb = create_sb(device, 0)
    const point_t_z_sb = create_sb(device, 0)
    const new_point_indices_sb = create_sb(device, 0)
    const cluster_start_indices_sb = create_sb(device, 0)
    const cluster_end_indices_sb = create_sb(device, 0)
